...
import '../../features/dashboard/presentation/pages/forms/resume_objectives.dart'
    as _i7;
import '../../features/dashboard/presentation/pages/forms/skills.dart' as _i6;
...
class AppRouter extends _i8.RootStackRouter {
  ...
  final Map<String, _i8.PageFactory> pagesMap = {
    ...
    ExperiencePageRoute.name: (routeData) {
      return _i8.CustomPage<dynamic>(
        routeData: routeData,
        child: const _i5.ExperiencePage(),
        transitionsBuilder: _i8.TransitionsBuilders.fadeIn,
        durationInMilliseconds: 400,
        reverseDurationInMilliseconds: 400,
        opaque: true,
    ...
    ResumeObjectiveRoute.name: (routeData) {
      return _i8.CustomPage<dynamic>(
        routeData: routeData,
        child: const _i7.ResumeObjective(),
        transitionsBuilder: _i8.TransitionsBuilders.fadeIn,
        durationInMilliseconds: 400,
        reverseDurationInMilliseconds: 400,
        opaque: true,
